...
<html lang="en">
    ...
    <body class=" login">
		...
		<div class="logo" style="margin-top: 0px; padding: 0px;">
            <a href="#">
                <img src="http://www.pksjatiasih.com/wp-content/uploads/2013/12/visi-misi-pks.png" style="height: 200px;" alt="" /> </a>
        </div>
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="<?=site_url('User/masuk');?>" method="post">
            ...
            <form class="forget-form" action="index.html" method="post">
                <div class="form-title" style="text-align: justify;">
                    <span class="form-title">Forget Your Password?</span>
                    <span class="form-subtitle">Please contact the administrator.</span>
                </div>
                <!-- <div class="form-group">
