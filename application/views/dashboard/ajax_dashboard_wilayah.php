									...
									foreach ($data_task as $key => $value) {
										$url33 = 'https://andro.sitri.online/api/calegtask/caleg/'.$value['Id_Caleg'];
										$data_task_caleg = $this->Main_model->getAPI($url33);
										
										foreach ($data_task_caleg as $key => $dt) {
											if($dt['Id_Wilayah']==$nilai){
												$jumlah_task++;
											}
											else{
												echo '';
										...
										$url34 = 'https://andro.sitri.online/api/calegmandiri/caleg/'.$value['Id_Caleg'];
										$data_task_caleg_mandiri = $this->Main_model->getAPI($url34);
										
										foreach ($data_task_caleg_mandiri as $key => $dt) {
											if($dt['Id_Wilayah']==$nilai){
												$jumlah_task++;
											}
											else{
									...
									<div class="row">
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
											<div class="dashboard-stat2 ">
												<?php
												$url1 = 'https://andro.sitri.online/api/calegtask/countsegmenwilayah/'.$nilai;
										...
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
											<div class="dashboard-stat2 ">
												<?php
													$url2 = 'https://andro.sitri.online/api/calegtask/countisuwilayah/'.$nilai;
										...
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
											<div class="dashboard-stat2 ">
												<div class="display">
													<div class="number">
														<h3 class="font-green-sharp">
															<span data-counter="counterup" data-value="567"><?php echo $jumlah_task; ?></span>
														</h3>
										...
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
											<div class="dashboard-stat2 ">
												<div class="display">
													<?php
													$url13 = 'https://andro.sitri.online/api/counttokoh/wilayah/'.$nilai;
									...
									<div class="row">
										...
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
											<div class="dashboard-stat2 ">
												<?php
													$url41 = 'https://andro.sitri.online/api/coverageall/wilayah/'.$nilai;
