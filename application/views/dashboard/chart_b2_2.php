											...
											<div class="mySlides2">
												...
												<div class="row">
														...
														<script type="text/javascript">
															...
															var chart = new Highcharts.Chart({
																...
																series: [{
																	...
																	$url2 = 'https://andro.sitri.online/api/strmandiri/wilayah/'.$nilaii;
																	$mandiri_str = $this->Main_model->getAPI($url2);
																	$url3 = 'https://andro.sitri.online/api/calegmandiri/wilayah/'.$nilaii;
													...
													<div class="col-md-6">
														...
														$suara3 = 0;
														$suara4 = 0;
														$url4 = 'https://andro.sitri.online/api/calegtask/wilayah/'.$nilaii;
														...
														$url5 = 'https://andro.sitri.online/api/strtask/wilayah/'.$nilaii;
