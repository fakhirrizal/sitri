				...
				<div class="mySlides">
					...
					<div class="row">
						<div class="col-md-6">
							<?php
							$arrayPie3 = array();
							$url6 = 'https://andro.sitri.online/api/strtask/segmensemua';
				...
				<div class="mySlides">
					...
					<div class="row">
						<div class="col-md-6">
							<?php
							$arrayPie4 = array();
							$url7 = 'https://andro.sitri.online/api/strtask/isusemua';
							...
							<script type="text/javascript">
								...
								var chart = new Highcharts.Chart({
									...
									credits: { enabled: false },title: {
										text: 'Rekap Sebaran Isu Semua Kegiatan'
									},
									tooltip: {
										pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b><br>Jumlah : <b>{point.y}</b>'
									},
						...
						<div class="col-md-6">
							<?php
							$arrayPie2 = array();
							$url4 = 'https://andro.sitri.online/api/calegtask/countisuall/asc';
