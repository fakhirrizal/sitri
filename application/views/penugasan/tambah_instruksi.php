...
$("#tingkat_dapil2").change(function(){
var value=$(this).val();
$.ajax({
data:{id:value,modul:'dapil'},
success: function(respond){
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="portlet light ">
                                        <div class="portlet-body form">
                                            <form role="form" enctype='multipart/form-data' class="form-horizontal" action="<?=site_url('Penugasan/simpan_instruksi');?>" method="post">
												<div class="form-body">
															...
															<div class="md-radio-inline">
																...
																<div class="md-radio has-warning">
																	...
																	<label for="radio3">
																		<span class="inc"></span>
																		<span class="check"></span>
																		<span class="box"></span> Struktur </label>
																</div>
															</div>
														</div>
													</div>
													<div class="form-group" id='pilihanrelawan' style='display: none'>
													<hr>
														...
														<div class="col-md-8">
															<div class="md-radio-inline">
																<div class="md-radio has-success">
																	<input type="radio" id="radio24" name="radio3" value='semua' class="md-radiobtn">
																	<label for="radio24">
																		<span class="inc"></span>
																		<span class="check"></span>
																...
																<div class="md-radio has-error">
																	<input type="radio" id="radio25" name="radio3" value='' class="md-radiobtn" checked="">
																	<label for="radio25">
																		<span class="inc"></span>
																		<span class="check"></span>
													...
													<div class="form-group" id='pilihancaleg'>
													<hr>
														<label class="control-label col-md-3">
														</label>
														<div class="col-md-8">
															<div class="md-radio-inline">
																<div class="md-radio has-success">
																	...
																	<label for="radio14">
																		<span class="inc"></span>
																		<span class="check"></span>
																		<span class="box"></span> Semua Caleg </label>
																</div>
																<div class="md-radio has-error">
													...
													<div class="form-group" id='pilihan_manual'>
														<label class="control-label col-md-3">Caleg
														...
														<div class="col-md-8 has-warning">
															...
															<p class="help-block">Silahkan pilih CAD yang akan ditugasi</p>
														</div>
													</div>
													<div class="form-group" id='pilihan_manual_relawan' style='display: none'>
