                                        ...
                                        <div class="portlet-body">
                                            <div class="tabbable-line">
                                                <ul class="nav nav-tabs ">
                                                    <li class="active">
                                                        <a href="#tab_15_1" data-toggle="tab"> Caleg Task </a>
                                                    </li>
                                                    <li>
																	...
																	<td>
																		<div class="btn-group">
																			...
																			<ul class="dropdown-menu" role="menu">
																				...
																				<li>
																					<a onclick="return confirm('Anda yakin?')" href="<?php echo site_url('Penugasan/hapus_task/2/'.$value['Id_TaskMandiri'])?>">
																						<i class="icon-trash"></i> Hapus Data </a>
																				</li>
																			</ul>
																		</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<ul class="cbp-l-project-details-list">
				...
				<a href="<?=base_url();?>Penugasan/download_lampiran2/<?= $row['Id_TaskMandiri']; ?>" target="_blank" class="btn blue uppercase"><i class="fa fa-download"></i> Unduh Lampiran</a>
			</ul>
        </div>
      </div>     
    </div>
