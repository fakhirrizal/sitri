...
<thead>
	<tr>
		<td colspan='12'><p style="text-align: center;" border='1'><b>JADWAL KEGIATAN CALON ANGGOTA DEWAN</b><br>DPR RI DKI JAKARTA 1 & DPRD DAPIL 4, 5, 6<br>PEMILU 2019</p><br> Update : <font color='red'><?php echo date('d-m-Y')?> | <?php echo date('H:i')?> WIB</font></td>
	</tr>
	<tr>
...
foreach ($cetakexceldpp as $dolay)
{
?>
	<tr>
		...
		<td style="text-align: center;"><?= $dolay['Jumlah_M']; ?></td>
		<td style="text-align: center;"><?= $dolay['Isu_Strategis']; ?></td>
		<td style="text-align: center;"><?= $dolay['Waktu_Realisasi']; ?></td>
