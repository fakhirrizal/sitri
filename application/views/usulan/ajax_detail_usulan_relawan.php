<?php
	foreach ($usulan as $key => $row) {
		if($row['Id_Usulan']==$id_usulan){
?>
			<ul class="cbp-l-project-details-list">
				<li>
					<strong>Pengusul</strong>&nbsp; &nbsp; &nbsp; &nbsp;<?php
					 $urldatastr = 'https://andro.sitri.online/api/strprofiles/id/'.$row['Id_Struktur'];
					 $datastr = $this->Main_model->getAPI($urldatastr);
					 echo $datastr['Nama'];
					 ?></li>
				...
				<li>
					<strong>Wilayah</strong>&nbsp; &nbsp; &nbsp; &nbsp;<?php
                                                        ...
                                                        elseif ($id_w==10) {
                                                                                    ...
                                                                                    //return response instead of outputting
                                                                                    curl_setopt($ch4, CURLOPT_RETURNTRANSFER, true);curl_setopt($c4, CURLOPT_SSL_VERIFYPEER, false);
                                                                                    //execute the POST request
                                                                                    $kel = curl_exec($ch4);
                                                                                    //close cURL resource
                                                                                    curl_close($ch4);
				...
				<li>
				<li>
					<strong>Nama Kegiatan</strong>&nbsp; &nbsp; &nbsp; &nbsp;<?=  $row['Nama_Usulan']; ?></li>
				<li>
