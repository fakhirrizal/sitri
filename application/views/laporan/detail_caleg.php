                        ...
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <span>Detail Kegiatan Caleg</span>
                            </li>
                        </ul>
                                    ...
                                    <div class="portlet light ">
                                        ...
                                        <div class="portlet-body">
                                            ...
                                            <ul class="cbp-l-project-details-list">
												...
												<li>
													<strong>Nama Caleg</strong>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
												<?= $data_caleg['Nama']; ?>
												</li>
												<li>
													<strong>Tingkat Pemilihan</strong>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
												<?= $data_caleg['Tingkat'] ?>
												</li>
												<li>
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="btn-group">
																		...
																		<span class="separator">|</span>
																		<a href="<?=site_url('Laporan/cetak_laporan_kegiatan_per_caleg/'.$this->uri->segment(3));?>" class="btn default uppercase">Cetak Data <i class="fa fa-print"></i> </a>
																</div>
													...
													<form action="#" method="post" onsubmit="return deleteConfirm();"/>
														...
														<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_2">
															...
															<tbody>
																<?php
																$nomor = 1;
																$url5 = 'https://andro.sitri.online/api/calegtask/calegnf/'.$this->uri->segment(3);
...
<?php
$url9 = 'https://andro.sitri.online/api/calegtask/calegnf/'.$this->uri->segment(3);
...
?>
<?php
$url10 = 'https://andro.sitri.online/api/calegmandiri/calegnf/'.$this->uri->segment(3);
