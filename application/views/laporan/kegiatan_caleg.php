                                            ...
                                            <div class="table-toolbar">
                                                <div class="row">
                                                    <div class="col-md-6">
														...
														<a href="<?=site_url('Penugasan/tambah_task_caleg');?>" class="btn blue uppercase">Tambah Data <i class="fa fa-plus"></i> </a>
														<span class="separator">|</span>
														<a href="<?=site_url('Laporan/cetak_laporan_kegiatan_caleg');?>" class="btn default uppercase">Cetak Data <i class="fa fa-print"></i> </a>
                                                    </div>
                                            ...
                                            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                                ...
                                                <tbody>
													...
													<tr class="odd gradeX">
                                                        ...
                                                        <td>
														<a href="<?=site_url('Laporan/detail_caleg/'.$value['Id_Caleg']);?>" class="btn btn-xs green">Detail</a>
                                                            <!-- <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu" role="menu">
                                                                    <li>
                                                                        <a href="<?=site_url('Laporan/detail_caleg/'.$value['Id_Caleg']);?>">
